...
$Q=mysql_query("select * from ujian_usukk");
...
$objPHPExcel->getActiveSheet()->setCellValue('B1', "Nomor Peserta");
...
$objPHPExcel->getActiveSheet()->setCellValue('I1', "Paket Keahlian"); 
$objPHPExcel->getActiveSheet()->setCellValue('J1', "Kelas"); 
$objPHPExcel->getActiveSheet()->setCellValue('K1', "Tahun Ajaran"); 
$objPHPExcel->getActiveSheet()->setCellValue('L1', "Username"); 
$objPHPExcel->getActiveSheet()->setCellValue('M1', "Ruang"); 
$objPHPExcel->getActiveSheet()->setCellValue('N1', "Tempat Duduk"); 
$objPHPExcel->getActiveSheet()->setCellValue('O1', "Seri Ijazah"); 
$objPHPExcel->getActiveSheet()->setCellValue('P1', "Nama Ortu"); 
...
cellColor('A1:P1', 'cccccc');
$baris=2;
$No=1;

while($H=mysql_fetch_array($Q)){
	
	$QOrtu=mysql_query("select * from siswa_ortu where nis='{$H['nis']}'");
	$HOrtu=mysql_fetch_array($QOrtu);


	$objPHPExcel->getActiveSheet()->setCellValue('A'.$baris, $No);
	$objPHPExcel->getActiveSheet()->setCellValue('B'.$baris, $H['nopeserta']);
	$objPHPExcel->getActiveSheet()->setCellValue('C'.$baris, $H['nis']);
	$objPHPExcel->getActiveSheet()->setCellValue('D'.$baris, "'".$H['nisn']);
	$objPHPExcel->getActiveSheet()->setCellValue('E'.$baris, $H['nm_siswa']);
	$objPHPExcel->getActiveSheet()->setCellValue('F'.$baris, $H['jk']);
	$objPHPExcel->getActiveSheet()->setCellValue('G'.$baris, $H['tmplahir']);
	$objPHPExcel->getActiveSheet()->setCellValue('H'.$baris, $H['tgllahir']);
	$objPHPExcel->getActiveSheet()->setCellValue('I'.$baris, $H['pk']);
	$objPHPExcel->getActiveSheet()->setCellValue('J'.$baris, $H['kelas']);
	$objPHPExcel->getActiveSheet()->setCellValue('K'.$baris, $H['thajaran']);
	$objPHPExcel->getActiveSheet()->setCellValue('L'.$baris, $H['username']);
	$objPHPExcel->getActiveSheet()->setCellValue('M'.$baris, $H['ruang']);
	$objPHPExcel->getActiveSheet()->setCellValue('N'.$baris, $H['tmpduduk']);
	$objPHPExcel->getActiveSheet()->setCellValue('O'.$baris, $H['noseriijazah']);
	$objPHPExcel->getActiveSheet()->setCellValue('P'.$baris, $HOrtu['nm_ayah']);
...
header('Content-Disposition: attachment;filename="datasiswa_usukk.xls"'); 
